...
static PathSegment * dev_temp_paths = NULL;
//for radix sort
...
void pathtraceInit(Scene *scene) {
    ...
    cudaMalloc(&dev_temp_paths, pixelcount * sizeof(PathSegment));
...
//sort rays based on material id --utility
