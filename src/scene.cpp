...
Scene::Scene(string filename) {
	...
	std::string warning;
	std::string error;
	std::string objfile = "../objs/cube.obj";
	...
	Geom cubeMesh;
	cubeMesh.materialid = 2;
	cubeMesh.type = MESH;
	cubeMesh.rotation = glm::vec3(0, 15, 0);
	cubeMesh.scale = glm::vec3(2, 2, 2);
	cubeMesh.translation = glm::vec3(2, 4, -1);
